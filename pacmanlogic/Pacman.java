...
/**
 * Logic class Pacman. Extends abstract class Entity and is used in Brain.
 */
public class Pacman extends Entity{
	...
	public Pacman(Pacman aPacman){
		this(aPacman.getPosition());
	}
	
	/**
	 * takes in user input and converts it into the correct format to be used in Brain.java
	*/
